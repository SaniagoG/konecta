                    ...
                    <div class="row">
                        <div class="mb-3">
                            ...
                            <input type="number" style="display: none ;"
                                value="<?php echo isset($this->producto->id) ?>">
                            <input type="text" class="form-control" name="n_nombre" id="id_nombre"
                                placeholder="Nombre del producto" value="<?php echo @$this->producto->nombre ?>"
                                required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="n_referencia" id="id_referencia"
                                placeholder="Referencia" value="<?php echo @$this->producto->referencia ?>" required>

                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Precio</label>
                            <input type="number" class="form-control" name="n_precio" id="id_precio"
                                placeholder="Valor producto" value="<?php echo @$this->producto->precio ?>" required>

                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label">Peso</label>
                            <input type="text" class="form-control" name="n_peso" id="id_peso" placeholder="Kg"
                                value="<?php echo @$this->producto->peso ?>" required>
                        </div>
                        <div class="mb-3">
                            <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="n_stock" id="id_stock"
                                placeholder="Cantidad" value="<?php echo @$this->producto->stock ?>" required>
                        </div>
